...
typedef enum
{
  BLE_SENSOR_MYDATA_READ_EVT,
  BLE_SENSOR_MYDATA_NOTIFY_ENABLED_EVT,
  BLE_SENSOR_MYDATA_NOTIFY_DISABLED_EVT,
  BLE_SENSOR_RECDATA_READ_EVT,
  BLE_SENSOR_RECDATA_WRITE_NO_RESP_EVT,
  BLE_SENSOR_RECDATA_WRITE_EVT,
  BLE_SENSOR_RECDATA_NOTIFY_ENABLED_EVT,
  BLE_SENSOR_RECDATA_NOTIFY_DISABLED_EVT,
