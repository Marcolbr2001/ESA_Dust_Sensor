...
clean-FATFS:
	-$(RM) ./FATFS/ff.cyclo ./FATFS/ff.d ./FATFS/ff.o ./FATFS/ff.su ./FATFS/ffsystem.cyclo ./FATFS/ffsystem.d ./FATFS/ffsystem.o ./FATFS/ffsystem.su ./FATFS/ffunicode.cyclo ./FATFS/ffunicode.d ./FATFS/ffunicode.o ./FATFS/ffunicode.su ./FATFS/user_diskio.cyclo ./FATFS/user_diskio.d ./FATFS/user_diskio.o ./FATFS/user_diskio.su ./FATFS/user_diskio_spi.cyclo ./FATFS/user_diskio_spi.d ./FATFS/user_diskio_spi.o ./FATFS/user_diskio_spi.su
