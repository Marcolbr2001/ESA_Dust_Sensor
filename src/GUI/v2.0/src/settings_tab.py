...
class SettingsTab(ctk.CTkFrame):
    ...
    def _on_material_selected(self, selection):
        """
        Quando l'utente seleziona un materiale:
        1. Recupera il valore 'dust_thresh_offset'.
        2. Aggiorna la UI.
        3. Invia il comando 'O<valore>' via BLE.
        """
        ...
        # Usiamo il prefisso 'O' per Offset. Es: "O10", "O50"
